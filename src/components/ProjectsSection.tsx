...
const ProjectsSection = ({
  ...
  useEffect(() => {
    ...
    const scrollTrigger = ScrollTrigger.create({
      ...
      start: 'top 10%',
      end: `+=${(trackHeight * window.innerHeight) / 100}px`,
      pin: stickyElement,
      pinSpacing: true,
      scrub: true,
      onUpdate: (self) => {
        const progress = self.progress;
        const scrollForwardDistance = progress * 1800;
              ...
              {projects.map((project, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <CornerSVG className="corner forth" uniqueId={project.id} />
                  </div>
                );
              })}
            </div>
