...
const TestimonialsSection = () => {
  ...
  useEffect(() => {
    ...
    const updateSlider = () => {
      const { cardWidth, gap } = getCardDimensions();
      const defaultCardHeight = getCardHeight(cardWidth, false);
      setCardDimensions({ width: cardWidth, height: defaultCardHeight, gap });
  ...
  // Play/pause videos based on active card
  useEffect(() => {
    const videos =
    ...
    videos.forEach((video, index) => {
      // Play video if it's the current active card
